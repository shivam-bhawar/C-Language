/* Que. 5: Write a C program to sort only even data using singly linked list
PPA8_Shivam_Bhawar */
#include<stdio.h>
#include<stdlib.h>
...
void sort_linkedlist(struct node** head) // Function to sort the even data values from the linked list in ascending order
{
...
void main()
{
	...
	do
	{
		...
		printf("1. Create the linked list\n2. Sort the even data values in the linked list in ascending order\n3. Display the linked list\n0. Exit\n");
