/* QUE. 2: C program to print diagonal elments in matrix using  Dynamic Memory Allocation
PPA8_Shivam_Bhawar */
#include<stdio.h>
#include<stdlib.h>
void main()
{
	...
	for(i=0;i<num_of_rows;i++) // Print the diagonal elements from the matrix
		{	
			for(j=0;j<num_of_columns;j++)
				{	
					if(i==j)
