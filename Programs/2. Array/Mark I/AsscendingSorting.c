/* QUE.5: C program to accept the array from the user and print it after sorting in assending order
PPA8_Shivam_Bhawar */
#include<stdio.h>
void main()
{
	...
	if(num_of_elements>0 && num_of_elements<=100)
		{
			...
			for(i=0;i<num_of_elements;i++) // Sort the elements in the array
				{
